...
var DTWebRTC = function (_EventEmitter) {
  ...
  function DTWebRTC(hypertyURL, bus, configuration) {
    ...
    var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(DTWebRTC).call(this));
    ...
    _this.ice = false; // if true then ice candidates will be handled
  ...
  _createClass(DTWebRTC, [{
    ...
    value: function invite() {
      ...
      this.createPC();
      return new Promise(function (resolve, reject) {
        console.log('>>>Constrains', _this2.constraints);
        navigator.mediaDevices.getUserMedia(_this2.constraints).then(function (stream) {
    ...
    value: function processPeerInformation(data) {
      ...
      if (data.type === 'answer') {
        ...
        that.pc.setRemoteDescription(new RTCSessionDescription(data)).then(function () {
          if (that.sender) {
...
},{"../../config.json":1,"../IdentityManager":6,"../utils/EventEmitter":7,"../utils/utils":8,"./stunTurnserverConfig":5,"service-framework/dist/HypertyDiscovery":2,"service-framework/dist/Syncher":3}],5:[function(require,module,exports){
'use strict';
...
},{"./utils/utils":8}],7:[function(require,module,exports){
"use strict";
