  ...
  _createClass(Sender, [{
    ...
    value: function createPC() {
      ...
      this.pc.onicecandidate = function (e) {
        ...
        if (!cand) return;
        if (!_this.ice) _this.iceBuffer.push(cand);else _this.sendIceCandidate(cand);
      };
    }
    ...
    value: function sendIceCandidate(cand) {
      var msg = {
        type: 'icecandidate',
        candidate: cand
      };
...
},{"../utils/EventEmitter":4,"../utils/utils":5,"./obj":3,"service-framework/dist/Syncher":1}],3:[function(require,module,exports){
"use strict";
