...
var Receiver = function (_EventEmitter) {
  ...
  _createClass(Receiver, [{
    ...
    value: function sendIceCandidate(c) {
      if (!this.objReporter.data.peer.iceCandidates) this.objReporter.data.peer.iceCandidates = []; // SHOULD BE REMOVED I GUESS BECAUSE OF "PEER"
    ...
    key: 'addIceCandidate',
    value: function addIceCandidate(cand) {
